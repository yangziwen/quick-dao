...
public class UserSpringJdbcRepositoryTest extends BaseRepositoryTest {
    ...
    public void testInsert() throws Exception {
        ...
        User user = User.builder()
                ...
                .updateTime(new Date())
                .build();
        UserSpringJdbcRepository repository = createRepository(dataSource);
    ...
    private UserSpringJdbcRepository createRepository(DataSource dataSource) {
